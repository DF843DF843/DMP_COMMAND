...
- **DMP Command External Domains** — domains treated as external by Agent 1/Agent 2's classification logic; Total rows count (no `Active` column by design - Agent 1 fully rewrites this list on every Emergency Report extraction); View + New Entry.
